...
export function Settings() {
  ...
  const mjpConfigComponent = accessStore.provider ===
    ServiceProvider.Midjourney && (
    <>
      <ListItem
        title={Locale.Settings.Access.Midjourney.Endpoint.Title}
        subTitle={
          Locale.Settings.Access.Midjourney.Endpoint.SubTitle +
          MJProxy.ExampleEndpoint
        }
      >
        <input
          type="text"
          value={accessStore.mjpUrl}
          placeholder={MJProxy.ExampleEndpoint}
          onChange={(e) =>
            accessStore.update(
              (access) => (access.mjpUrl = e.currentTarget.value),
            )
          }
        ></input>
      </ListItem>
      <ListItem
        title={Locale.Settings.Access.Midjourney.ApiKey.Title}
        subTitle={Locale.Settings.Access.Midjourney.ApiKey.SubTitle}
      >
        <PasswordInput
          value={accessStore.mjpApiKey}
          type="text"
          placeholder={Locale.Settings.Access.Midjourney.ApiKey.Placeholder}
          onChange={(e) => {
            accessStore.update(
              (access) => (access.mjpApiKey = e.currentTarget.value),
            );
          }}
        />
      </ListItem>
